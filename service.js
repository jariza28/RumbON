...
$$('#aLogin').tap(function() {
    ...
    var url = "http://rumbon.pagodabox.com/api/loginuser/";
...
$$('#aEnviarRegistro').tap(function() {
    ...
    var url = "http://rumbon.pagodabox.com/api/register/";
...
$$('#aRest').tap(function() {
    var template,html;
    var url = "http://rumbon.pagodabox.com/api/restaurantbystatu";
        ...
        template ='<li>Abiertos Ahora</li>\
                    ...
                    <ul>{{#datos}}\
                     <li class="thumb selectable" id="{{id}}">\
                        ...
                        <img src="http://rumbon.pagodabox.com/uploads/thumbnails/restaurants/{{image}}" />\
                        <strong>{{name}}</strong>\
...
$$('#tipoclub').tap(function() {
    ...
    var url = "http://rumbon.pagodabox.com/api/clubytype/"+tipo;

    var parseResponse = function(result){
        template ='<ul>{{#datos}}\
                     <li class="thumb selectable" id="{{id}}">\
                        <div class="right">{{telephone}} - {{address}}</div>\
                        <img src="http://rumbon.pagodabox.com/uploads/thumbnails/clubs/{{image}}" />\
                        <strong>{{name}}</strong>\
                        <small>{{description}}</small>\
                    </li>\
                    {{/datos}}\
...
$$('article#listaresultipo ul li').tap(function() {
    ...
    Lungo.Notification.confirm({
        ...
        accept: {
            ...
            label: 'Si',
            callback: function(){ 
                var url = "http://rumbon.pagodabox.com/api/go/";
